      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          <input
            ...
            className="w-full px-5 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-400 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <input
            type="email"
