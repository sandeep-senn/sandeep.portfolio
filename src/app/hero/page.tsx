...
const Hero = () => {
  ...
  const HeroLottieBg = dynamic(() => import("@/components/HeroLottieBg"), { ssr: false });
  ...
  return (
    <>
      <section ref={heroRef} className="relative min-h-screen bg-white text-black overflow-hidden pb-20 shadow-inner h-1">
        ...
        {/* Text */}
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight">          {/* BlurText below name */}
          {typeof window !== 'undefined' && (
            <div className="w-full flex justify-center">
              {(() => {
                const BlurText = require("@/components/ui/BlurText").default;
